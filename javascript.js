let strikeGame = document.getElementById("strike");
...
// strikeGame.addEventListener("click", strikeButton);
...
function strikeButton(){
    ...
    if(turn==1){
        ...
        if(team1Ball==6 || team1Wickets==2|| turn==2){
            turn =2;
        }
        if(randomElement=="W"){
            team1Wickets++;
...
// // Add an event listener for the strike button, assuming `strikeButton` is the correct ID.
// strikeGame.addEventListener("click", strikeButton);
